...
using TechnoLogica.IdentityServer.Models.Consent;
using TechnoLogica.IdentityServer.Models.Device;
using TechnoLogica.IdentityServer.Options;
using TechnoLogica.IdentityServer.Utils;

namespace TechnoLogica.IdentityServer.Controllers.Device
{
    [Authorize]
    [SecurityHeaders]
