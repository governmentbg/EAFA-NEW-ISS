...
{
    public class IntReportValidation : TLBaseViewModel, IReportValidation
    {
        public IntReportValidation(bool isMandatory, string defaultValue, string pattern, string errorMessage)
        {
            this.AddValidation();
        ...
        [TLRange(int.MinValue, int.MaxValue)]
