...
{
    public class ElderAssociationTicketViewModel : BaseTicketViewModel
    {
        ...
        public ElderAssociationTicketViewModel(IFishingTicketsSettings fishingTicketsSettings)
        ...
        protected override TicketValidationDTO GetTicketValidationData()
        {
            return new TicketValidationDTO()
            {
                ...
                TypeCode = nameof(TicketTypeEnum.ELDERASSOCIATION),
                ValidFrom = TicketValidFrom.Date == DateTime.Now.Date ? DateTime.Now : TicketValidFrom,
            };
        }
