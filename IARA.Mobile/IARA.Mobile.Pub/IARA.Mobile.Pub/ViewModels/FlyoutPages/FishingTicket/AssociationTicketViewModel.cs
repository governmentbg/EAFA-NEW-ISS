...
{
    public class AssociationTicketViewModel : BaseTicketViewModel
    {
        ...
        public AssociationTicketViewModel(IFishingTicketsSettings fishingTicketsSettings)
        ...
        protected override TicketValidationDTO GetTicketValidationData()
        {
            return new TicketValidationDTO()
            {
                ...
                TypeCode = nameof(TicketTypeEnum.ASSOCIATION),
                ValidFrom = TicketValidFrom.Date == DateTime.Now.Date ? DateTime.Now : TicketValidFrom,
            };
        }
