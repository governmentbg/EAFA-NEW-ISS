...
namespace IARA.Mobile.Insp.Helpers
{
    public static class InspectionHelper
    {
        ...
        public static void InitShip(FishingShipViewModel fishingShip, ShipChecksViewModel shipChecks, ShipCatchesViewModel shipCatches, FishingGearsViewModel fishingGears = null)
        {
            fishingShip.ShipData.ShipSelected = CommandBuilder.CreateFrom(
                async (ShipSelectNomenclatureDto ship) =>
                {
                    ...
                    ResetOldDependantData(fishingShip, shipChecks, shipCatches, fishingGears);
                    await LoadShipDependantData(fishingShip, shipChecks, shipCatches, fishingGears, ship, nomTransaction, ship.Uid);
                    LoadShipPernonnel(fishingShip, nomTransaction, ship.Uid);
        ...
        private static void ResetOldDependantData(FishingShipViewModel fishingShip, ShipChecksViewModel shipChecks, ShipCatchesViewModel shipCatches, FishingGearsViewModel fishingGears)
        {
            fishingShip.Reset();
            shipChecks.Reset();
            shipCatches.Reset();
        ...
        private static void LoadShipPernonnel(FishingShipViewModel fishingShip, INomenclatureTransaction nomTransaction, int uid)
        {
        ...
        private static async Task LoadShipDependantData(FishingShipViewModel fishingShip, ShipChecksViewModel shipChecks, ShipCatchesViewModel shipCatches, FishingGearsViewModel fishingGears, ShipSelectNomenclatureDto ship, INomenclatureTransaction nomTransaction, int uid)
        {
