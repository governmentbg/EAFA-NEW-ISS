...
{
    public class TLCheckBoxWithPicker : TLPicker
    {
        ...
        public static readonly BindableProperty CheckValidStateProperty =
            BindableProperty.Create(nameof(CheckValidState), typeof(IValidState<bool>), typeof(TLCheckBoxWithPicker));

        public TLCheckBoxWithPicker()
        {
