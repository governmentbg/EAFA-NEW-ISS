        ...
        private Task OnSave()
        {
            ...
            return HideDialog(new WaterFishingGearModel
            {
                ...
                Dto = new WaterInspectionFishingGearDto
                {
                    ...
                    LineCount = ParseHelper.ParseInteger(FishingGearGeneralInfo.LineCount),
                    NetNominalLength = ParseHelper.ParseInteger(FishingGearGeneralInfo.NetNominalLength),
                    NetsInFleetCount = ParseHelper.ParseInteger(FishingGearGeneralInfo.NetsInFleetCount),
                    TrawlModel = FishingGearGeneralInfo.TrawlModel,
