...
namespace IARA.Mobile.Insp.FlyoutPages.Inspections.HarbourInspection
{
    ...
    {
        public HarbourInspectionPage(SubmitType submitType = SubmitType.Draft, ViewActivityType activityType = ViewActivityType.Add, InspectionTransboardingDto dto = null, bool isLocal = false, bool createdByCurrentUser = true)
        {
