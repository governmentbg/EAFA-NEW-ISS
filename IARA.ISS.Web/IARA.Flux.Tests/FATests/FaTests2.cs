...
{
    public static class FaTests2
    {
        /// <summary>
        /// 1. Тръгване
        /// 2. Пускане и вдигане на уред(125 кг цаца уловена, 125 кг изхвърлена)
        /// 3. (Уведомление) и връщане
        /// 4. Празна декларация
        /// </summary>
        /// <returns></returns>
        public static List<FLUXFAReportMessageType> Test21DiscardTripOneFoDiscardAll()
        {
            ...
            DateTime arrivalNotificationTime = discardTime.AddHours(2);
            DateTime arrivalDeclarationTime = discardTime.AddHours(2).AddMinutes(10);
        ...
        /// 3. Пускане и вдигане на уред(100 кг цаца уловена, 25 кг изхвърлена)
        /// 4. (Уведомление) и връщане
        /// 5. Разтоварване(100 кг цаца, 75 кг цаца)
        /// </summary>
        /// <returns></returns>
        public static List<FLUXFAReportMessageType> Test22DiscardTripTwoFoDiscardPartOfSecondFo()
        {
            DateTime departureTime = DateTime.Now;
            DateTime gearShotTime = departureTime.AddHours(2);
            DateTime gearRetrievalTime = gearShotTime.AddHours(4);
            DateTime gearShot2Time = gearRetrievalTime.AddHours(1);
            DateTime gearRetrieval2Time = gearShot2Time.AddHours(2);
            DateTime discardTime = gearRetrieval2Time.AddMinutes(30);
            DateTime arrivalNotificationTime = discardTime.AddHours(2);
            DateTime arrivalDeclarationTime = discardTime.AddHours(2).AddMinutes(10);
            DateTime landingStartTime = arrivalDeclarationTime.AddMinutes(30);
            DateTime landingEndTime = arrivalDeclarationTime.AddMinutes(55);
