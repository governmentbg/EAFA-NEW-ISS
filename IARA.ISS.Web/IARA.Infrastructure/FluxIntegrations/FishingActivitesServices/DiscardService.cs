...
{
    internal class DiscardService : BaseFishingActivityService
    {
        public DiscardService(IARADbContext dbContext, IExtendedLogger logger)
            : base(dbContext, logger, "DiscardService.cs")
        { }

        public List<ShipLogBookPage> MapOriginal(IDType[] relatedFLUXReportDocumentIds, FishingActivityType fishingActivity)
        {
        ...
        private List<ShipLogBookPage> MapUpdate(FishingActivityType fishingActivity,
                                                                                    ...
                                                                                    IDType referenceId)
        {
            ...
            List<ShipLogBookPage> shipLogBookPages = MapOriginal(relatedFLUXReportDocumentIds, fishingActivity);
                                                                           ...
                                                                           List<string> catchTypeCodes = null)
        {
            ...
            {
                string msg = $"no related document for discard operation + no fishing trip identifier in the fishing activity in the present message as well";
                LogWarning(msg, "GetTripCatchRecordFishesData");
            }
