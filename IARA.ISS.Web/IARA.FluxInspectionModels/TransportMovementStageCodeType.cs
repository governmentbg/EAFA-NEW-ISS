namespace IARA.FluxInspectionModels
{
    ...
    public partial class TransportMovementStageCodeType
    {

        private string listIDField;

        private TransportMovementStageCodeListAgencyIDContentType listAgencyIDField;
        ...
        private TransportMovementStageCodeContentType valueField;

        public TransportMovementStageCodeType()
        {
            this.listIDField = "8051";
            this.listAgencyIDField = TransportMovementStageCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute]
        public TransportMovementStageCodeListAgencyIDContentType listAgencyID
        {
            get
            {
        ...
        [XmlText]
        public TransportMovementStageCodeContentType Value
        {
            get
            {
