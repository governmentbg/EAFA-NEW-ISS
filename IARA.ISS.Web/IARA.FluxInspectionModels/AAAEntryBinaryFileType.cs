namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAEntryBinaryFile", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAEntryBinaryFileType
    {
