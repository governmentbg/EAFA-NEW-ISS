namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("RecreationFacility", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class RecreationFacilityType
    {
