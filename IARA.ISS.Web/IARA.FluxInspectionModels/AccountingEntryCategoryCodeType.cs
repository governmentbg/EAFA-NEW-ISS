namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingEntryCategoryCodeType
    {
        ...
        private AccountingEntryCategoryContentType valueField;

        public AccountingEntryCategoryCodeType()
        {
            this.listIDField = "AccountingE202";
        ...
        [XmlText]
        public AccountingEntryCategoryContentType Value
        {
            get
            {
