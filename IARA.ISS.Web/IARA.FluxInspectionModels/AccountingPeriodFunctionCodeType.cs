namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingPeriodFunctionCodeType
    {
        ...
        private AccountingPeriodFunctionTypeContentType valueField;

        public AccountingPeriodFunctionCodeType()
        {
            this.listIDField = "AccountingE703";
        ...
        [XmlText]
        public AccountingPeriodFunctionTypeContentType Value
        {
            get
            {
