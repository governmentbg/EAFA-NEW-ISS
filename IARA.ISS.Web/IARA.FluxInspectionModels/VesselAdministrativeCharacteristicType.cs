namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("VesselAdministrativeCharacteristic", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
