namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingAccountNatureTypeCodeType
    {
        ...
        private AccountingAccountNatureTypeContentType valueField;

        public AccountingAccountNatureTypeCodeType()
        {
            this.listIDField = "AccountingE502";
        ...
        [XmlText]
        public AccountingAccountNatureTypeContentType Value
        {
            get
            {
