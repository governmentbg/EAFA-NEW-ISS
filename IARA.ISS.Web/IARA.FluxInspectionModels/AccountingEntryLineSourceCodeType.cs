namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingEntryLineSourceCodeType
    {
        ...
        private AccountingEntryLineSourceContentType valueField;

        public AccountingEntryLineSourceCodeType()
        {
            this.listIDField = "AccountingE302";
        ...
        [XmlText]
        public AccountingEntryLineSourceContentType Value
        {
            get
            {
