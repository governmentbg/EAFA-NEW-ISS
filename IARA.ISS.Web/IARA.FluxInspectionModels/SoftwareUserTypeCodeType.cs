namespace IARA.FluxInspectionModels
{
    ...
    public partial class SoftwareUserTypeCodeType
    {
        ...
        private SoftwareUserTypeContentType valueField;

        public SoftwareUserTypeCodeType()
        {
            this.listIDField = "SoftwareUserTypeE019";
        ...
        [XmlText]
        public SoftwareUserTypeContentType Value
        {
            get
            {
