namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("UnspecifiedChemicalPropertyRangeMeasurement", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class UnspecifiedChemicalPropertyRangeMeasurementType
    {
