namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAWrapDayBook", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAWrapDayBookType
    {
