namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAJournalBookAccountingLineMonetaryValue", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAJournalBookAccountingLineMonetaryValueType
    {
        ...
        private AAAJournalBookAccountingAccountType[] bookingAAAJournalBookAccountingAccountField;
        ...
        [XmlElement("BookingAAAJournalBookAccountingAccount")]
        public AAAJournalBookAccountingAccountType[] BookingAAAJournalBookAccountingAccount
        {
            get
            {
                return this.bookingAAAJournalBookAccountingAccountField;
            }
            set
            {
                this.bookingAAAJournalBookAccountingAccountField = value;
            }
        }
    }
}