namespace IARA.FluxInspectionModels
{
    ...
    public partial class FinancialAccountTypeCodeType
    {
        ...
        private FinancialAccountTypeContentType valueField;

        public FinancialAccountTypeCodeType()
        {
            this.listIDField = "AccountingE016";
        ...
        [XmlText]
        public FinancialAccountTypeContentType Value
        {
            get
            {
