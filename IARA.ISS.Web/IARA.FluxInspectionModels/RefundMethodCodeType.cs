namespace IARA.FluxInspectionModels
{
    ...
    public partial class RefundMethodCodeType
    {
        ...
        private RefundMethodContentType valueField;

        public RefundMethodCodeType()
        {
            this.listIDField = "RefundMethodE022";
        ...
        [XmlText]
        public RefundMethodContentType Value
        {
            get
            {
