namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("SubjectClassification", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class SubjectClassificationType
    {
