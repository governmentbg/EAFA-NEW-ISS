namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingDocumentCodeType
    {

        private string listIDField;

        private AccountingDocumentCodeListAgencyIDContentType listAgencyIDField;
        ...
        private DocumentNameCodeAccountingContentType valueField;

        public AccountingDocumentCodeType()
        {
            this.listIDField = "1001_Accounting";
            this.listAgencyIDField = AccountingDocumentCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute]
        public AccountingDocumentCodeListAgencyIDContentType listAgencyID
        {
            get
            {
        ...
        [XmlText]
        public DocumentNameCodeAccountingContentType Value
        {
            get
            {
