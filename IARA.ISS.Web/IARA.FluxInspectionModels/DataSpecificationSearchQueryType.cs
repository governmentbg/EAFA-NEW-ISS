namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("DataSpecificationSearchQuery", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class DataSpecificationSearchQueryType
    {
