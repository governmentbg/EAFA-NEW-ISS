namespace IARA.FluxInspectionModels
{
    ...
    public partial class ContractorTypeCodeType
    {
        ...
        private ContractorTypeContentType valueField;

        public ContractorTypeCodeType()
        {
            this.listIDField = "Contractor Type";
        ...
        [XmlText]
        public ContractorTypeContentType Value
        {
            get => this.valueField;
