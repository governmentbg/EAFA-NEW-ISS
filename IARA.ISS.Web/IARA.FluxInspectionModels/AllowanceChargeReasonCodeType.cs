namespace IARA.FluxInspectionModels
{
    ...
    public partial class AllowanceChargeReasonCodeType
    {
        ...
        private AllowanceChargeReasonCodeListAgencyIDContentType listAgencyIDField;
        ...
        {
            this.listIDField = "4465_AllowanceChargeReasonCode";
            this.listAgencyIDField = AllowanceChargeReasonCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute]
        public AllowanceChargeReasonCodeListAgencyIDContentType listAgencyID
        {
