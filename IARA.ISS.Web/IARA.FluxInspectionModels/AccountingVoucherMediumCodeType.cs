namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingVoucherMediumCodeType
    {
        ...
        private AccountingVoucherMediumContentType valueField;

        public AccountingVoucherMediumCodeType()
        {
            this.listIDField = "AccountingE101";
        ...
        [XmlText]
        public AccountingVoucherMediumContentType Value
        {
            get
            {
