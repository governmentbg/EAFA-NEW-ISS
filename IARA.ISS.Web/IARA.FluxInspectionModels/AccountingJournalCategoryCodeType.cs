namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingJournalCategoryCodeType
    {
        ...
        private AccountingJournalCategoryContentType valueField;

        public AccountingJournalCategoryCodeType()
        {
            this.listIDField = "AccountingE013";
        ...
        [XmlText]
        public AccountingJournalCategoryContentType Value
        {
            get
            {
