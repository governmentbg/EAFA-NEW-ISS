namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAALedgerMonetaryInstalment", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAALedgerMonetaryInstalmentType
    {
