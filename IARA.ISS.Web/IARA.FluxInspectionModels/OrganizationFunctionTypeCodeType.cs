namespace IARA.FluxInspectionModels
{
    ...
    public partial class OrganizationFunctionTypeCodeType
    {
        ...
        private OrganizationFunctionTypeContentType valueField;

        public OrganizationFunctionTypeCodeType()
        {
            this.listIDField = "OrganizationFunctionTypeE706";
        ...
        [XmlText]
        public OrganizationFunctionTypeContentType Value
        {
            get
            {
