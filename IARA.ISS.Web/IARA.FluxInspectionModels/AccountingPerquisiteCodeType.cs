namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingPerquisiteCodeType
    {
        ...
        private AccountingPerquisiteContentType valueField;

        public AccountingPerquisiteCodeType()
        {
            this.listIDField = "AccountingE021";
        ...
        [XmlText]
        public AccountingPerquisiteContentType Value
        {
            get
            {
