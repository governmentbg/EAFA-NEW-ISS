namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("CISSILSupplyChainTradeDelivery", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class CISSILSupplyChainTradeDeliveryType
    {
        ...
        private CILogisticsLabelType[] usedCILogisticsLabelField;
        ...
        [XmlElement("RequestedDeliveryCISupplyChainEvent")]
        ...
        [XmlElement("RequestedDespatchCISupplyChainEvent")]
        ...
        [XmlElement("UsedCILogisticsLabel")]
        public CILogisticsLabelType[] UsedCILogisticsLabel
        {
            get => this.usedCILogisticsLabelField;
            set => this.usedCILogisticsLabelField = value;
        }
