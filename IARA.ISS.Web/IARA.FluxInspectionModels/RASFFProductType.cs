namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("RASFFProduct", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class RASFFProductType
    {
        ...
        private RASFFProductType[] variantRASFFProductField;
        ...
        [XmlElement("VariantRASFFProduct")]
        public RASFFProductType[] VariantRASFFProduct
        {
            get => this.variantRASFFProductField;
            set => this.variantRASFFProductField = value;
        }
