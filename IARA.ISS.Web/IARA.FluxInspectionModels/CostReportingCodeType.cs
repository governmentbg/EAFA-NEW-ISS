namespace IARA.FluxInspectionModels
{
    ...
    public partial class CostReportingCodeType
    {
        ...
        private CostReportingCodeContentType valueField;

        public CostReportingCodeType()
        {
            this.listIDField = "9655";
        ...
        [XmlText]
        public CostReportingCodeContentType Value
        {
            get => this.valueField;
