namespace IARA.FluxInspectionModels
{
    ...
    public partial class PartyTypeCodeType
    {
        ...
        private PartyTypeContentType valueField;

        public PartyTypeCodeType()
        {
            this.listIDField = "PartyTypeE705";
        ...
        [XmlText]
        public PartyTypeContentType Value
        {
            get
            {
