namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAJournalBookCapitalAssetAmortization", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAJournalBookCapitalAssetAmortizationType
    {
