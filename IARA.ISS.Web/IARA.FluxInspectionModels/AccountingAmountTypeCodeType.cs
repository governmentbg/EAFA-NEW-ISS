namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingAmountTypeCodeType
    {
        ...
        private AccountingAmountTypeContentType valueField;

        public AccountingAmountTypeCodeType()
        {
            this.listIDField = "AccountingE601";
        ...
        [XmlText]
        public AccountingAmountTypeContentType Value
        {
            get
            {
