namespace IARA.FluxInspectionModels
{
    ...
    public partial class ReportingThresholdTriggerTypeCodeType
    {
        ...
        private ReportingThresholdTriggerTypeContentType valueField;

        public ReportingThresholdTriggerTypeCodeType()
        {
            this.listIDField = "9667";
        ...
        [XmlText]
        public ReportingThresholdTriggerTypeContentType Value
        {
            get => this.valueField;
