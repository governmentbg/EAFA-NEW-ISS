namespace IARA.FluxInspectionModels
{
    ...
    public partial class RemittanceDocumentCodeType
    {

        private string listIDField;

        private RemittanceDocumentCodeListAgencyIDContentType listAgencyIDField;
        ...
        private DocumentNameCodeRemittanceContentType valueField;

        public RemittanceDocumentCodeType()
        {
            this.listIDField = "1001_DocumentTypeCode_Remittance";
            this.listAgencyIDField = RemittanceDocumentCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute]
        public RemittanceDocumentCodeListAgencyIDContentType listAgencyID
        {
        ...
        [XmlText]
        public DocumentNameCodeRemittanceContentType Value
        {
            get => this.valueField;
