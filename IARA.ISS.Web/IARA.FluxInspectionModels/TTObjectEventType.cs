namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("TTObjectEvent", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class TTObjectEventType
    {
