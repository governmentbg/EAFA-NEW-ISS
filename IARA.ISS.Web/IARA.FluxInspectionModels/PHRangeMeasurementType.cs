namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("PHRangeMeasurement", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class PHRangeMeasurementType
    {
