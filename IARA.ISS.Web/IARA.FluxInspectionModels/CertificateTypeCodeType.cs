namespace IARA.FluxInspectionModels
{
    ...
    public partial class CertificateTypeCodeType
    {
        ...
        private CertificateTypeContentType valueField;

        public CertificateTypeCodeType()
        {
            this.listIDField = "AccountingE004";
        ...
        [XmlText]
        public CertificateTypeContentType Value
        {
            get
            {
