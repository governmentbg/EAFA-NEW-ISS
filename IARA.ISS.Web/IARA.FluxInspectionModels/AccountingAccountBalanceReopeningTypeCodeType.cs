namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingAccountBalanceReopeningTypeCodeType
    {
        ...
        private AccountingAccountBalanceReopeningTypeContentType valueField;

        public AccountingAccountBalanceReopeningTypeCodeType()
        {
            this.listIDField = "AccountingE602";
        ...
        [XmlText]
        public AccountingAccountBalanceReopeningTypeContentType Value
        {
            get
            {
