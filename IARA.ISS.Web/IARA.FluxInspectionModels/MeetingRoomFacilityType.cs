namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("MeetingRoomFacility", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class MeetingRoomFacilityType
    {
