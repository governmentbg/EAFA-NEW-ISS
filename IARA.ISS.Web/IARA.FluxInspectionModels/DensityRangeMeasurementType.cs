namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("DensityRangeMeasurement", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class DensityRangeMeasurementType
    {
