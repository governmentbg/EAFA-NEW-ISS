namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAEntryTax", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAEntryTaxType
    {
        ...
        private AAAEntryAccountingAccountType[] specifiedAAAEntryAccountingAccountField;
        ...
        [XmlElement("SpecifiedAAAEntryAccountingAccount")]
        public AAAEntryAccountingAccountType[] SpecifiedAAAEntryAccountingAccount
        {
            get
            {
                return this.specifiedAAAEntryAccountingAccountField;
            }
            set
            {
                this.specifiedAAAEntryAccountingAccountField = value;
            }
        }
    }
}