namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingDocumentTypeCodeType
    {
        ...
        private AccountingDocumentTypeContentType valueField;

        public AccountingDocumentTypeCodeType()
        {
            this.listIDField = "AccountingE006";
        ...
        [XmlText]
        public AccountingDocumentTypeContentType Value
        {
            get
            {
