namespace IARA.FluxInspectionModels
{
    ...
    public partial class AccountingEntryProcessingCodeType
    {
        ...
        private AccountingEntryProcessingContentType valueField;

        public AccountingEntryProcessingCodeType()
        {
            this.listIDField = "AccountingE201";
        ...
        [XmlText]
        public AccountingEntryProcessingContentType Value
        {
            get
            {
