namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("SampleObservationResultCharacteristic", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class SampleObservationResultCharacteristicType
    {
