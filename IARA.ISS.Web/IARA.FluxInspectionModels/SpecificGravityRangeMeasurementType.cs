namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("SpecificGravityRangeMeasurement", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class SpecificGravityRangeMeasurementType
    {
