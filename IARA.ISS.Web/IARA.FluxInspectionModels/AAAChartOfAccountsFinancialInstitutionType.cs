...
namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAAChartOfAccountsFinancialInstitution", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAAChartOfAccountsFinancialInstitutionType
    {
