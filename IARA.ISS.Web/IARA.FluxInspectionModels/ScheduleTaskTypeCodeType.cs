namespace IARA.FluxInspectionModels
{
    ...
    public partial class ScheduleTaskTypeCodeType
    {
        ...
        private ScheduleTaskTypeContentType valueField;

        public ScheduleTaskTypeCodeType()
        {
            this.listIDField = "9675";
        ...
        [XmlText]
        public ScheduleTaskTypeContentType Value
        {
            get => this.valueField;
