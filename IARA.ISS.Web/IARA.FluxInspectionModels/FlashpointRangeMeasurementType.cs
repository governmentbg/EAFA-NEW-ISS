namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("FlashpointRangeMeasurement", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class FlashpointRangeMeasurementType
    {
