namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("ProjectArtefactRetrievalQuery", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class ProjectArtefactRetrievalQueryType
    {
