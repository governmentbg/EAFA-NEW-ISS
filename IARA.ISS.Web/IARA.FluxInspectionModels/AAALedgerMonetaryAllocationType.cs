namespace IARA.FluxInspectionModels
{
    ...
    [XmlRoot("AAALedgerMonetaryAllocation", Namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:32", IsNullable = false)]
    public partial class AAALedgerMonetaryAllocationType
    {
