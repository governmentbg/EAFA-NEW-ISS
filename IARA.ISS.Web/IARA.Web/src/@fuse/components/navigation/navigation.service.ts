...
export class FuseNavigationService {
     ...
     *
     * @param {string} key
     * @param {FuseNavigation[]} navigation
     */
     ...
     * @returns {any[]}
     */
    getFlatNavigation(navigation: FuseNavigation[], flatNavigation: FuseNavigationItem[] = []): any {
     ...
     *
     * @param id: string
     * @param {FuseNavigationItem[]} navigation
     * @returns {any | boolean}
     */
    getNavigationItem(id: string, navigation?: FuseNavigationItem[]): any | boolean {
        if (!navigation) {
            navigation = this.getCurrentNavigation();
        }
        if (navigation) {
            for (const item of navigation as FuseNavigation[]) {
                if (item.id === id) {
                    return item;
                }
     ...
     * @param parent
     */
    getNavigationItemParent(id: string, navigation?: FuseNavigation[], parent?: FuseNavigation[] | FuseNavigation): any {
        if (!navigation) {
            navigation = this.getCurrentNavigation();
            parent = navigation;
        }
