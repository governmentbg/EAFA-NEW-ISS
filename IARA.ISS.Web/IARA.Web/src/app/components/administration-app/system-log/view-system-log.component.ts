...
export class ViewSystemLogComponent implements IDialogComponent, AfterViewInit {
    ...
    private fillForm(): void {
        this.formGroup.get('uniqueNumberControl')!.setValue(this.systemLog.id);
        this.formGroup.get('dateTimeControl')!.setValue(this.systemLog.logDate);
        this.formGroup.get('actionTypeControl')!.setValue(this.systemLog.actionType);
        this.formGroup.get('applicationControl')!.setValue(this.systemLog.application);
        this.formGroup.get('moduleControl')!.setValue(this.systemLog.module);
        this.formGroup.get('actionControl')!.setValue(this.systemLog.action);
        this.formGroup.get('objectControl')!.setValue(this.systemLog.tableName);
        this.formGroup.get('userControl')!.setValue(this.systemLog.username);
        this.formGroup.get('ipControl')!.setValue(this.systemLog.ipAddress);
        this.formGroup.get('browserControl')!.setValue(this.systemLog.browserInfo);
        this.formGroup.get('tableIdControl')!.setValue(this.systemLog.tableId);
    }
