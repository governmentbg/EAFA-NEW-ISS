...
@Component({
    selector: 'print-configurations-dialog',
    templateUrl: './print-configurations-dialog.component.html'
})
export class PrintConfigurationsDialogComponent implements IDialogComponent, OnInit {
