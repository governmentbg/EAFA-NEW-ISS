...
namespace IARA.EntityModels.Entities
{
    ...
    /// </summary>
    [Table("NCatchInspectionTypes", Schema = "RInsp")]
    [Index(nameof(Code), nameof(ValidTo), Name = "UK_RInsp_NCatchInspectionTypes", IsUnique = true)]
    public partial class NcatchInspectionType
    {
        public NcatchInspectionType()
        {
        ...
        [InverseProperty(nameof(InspectionCatchMeasure.CatchInspectionType))]
