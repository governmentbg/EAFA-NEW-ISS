...
namespace IARA.EntityModels.Entities
{
    ...
    /// Видове гориво
    /// </summary>
    [Table("NFuelTypes", Schema = "Noms")]
    [Index(nameof(Code), nameof(ValidTo), Name = "UK_Noms_NFuelTypes", IsUnique = true)]
    public partial class NfuelType
    {
        public NfuelType()
        {
        ...
        [InverseProperty(nameof(FishVesselsForm.FuelType))]
        public virtual ICollection<FishVesselsForm> FishVesselsForms { get; set; }
        [InverseProperty(nameof(ShipRegister.FuelType))]
