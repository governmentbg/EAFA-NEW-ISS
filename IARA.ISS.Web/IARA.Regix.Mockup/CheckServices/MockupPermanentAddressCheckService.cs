...
{
    public class MockupPermanentAddressCheckService : BasePermanentAddressCheckService
    {
        public MockupPermanentAddressCheckService(ConnectionStrings connectionString,
                                                                                       ...
                                                                                       RegixContextData<PermanentAddressRequestType, RegixPersonContext> data)
        {
            return GetResponse(data, async (request) =>
            {
                ...
                return RegixChecksMockups.PERMANENT_ADDRESS;
            });
        }
